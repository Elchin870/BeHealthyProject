...
namespace BeHealthyProject.Server.Migrations
{
    ...
    [Migration("20250523185150_addCertificate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.RefreshToken", b =>
                {
                    b.HasOne("BeHealthyProject.Entities.BaseUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BeHealthyProject.Entities.Subscriber", b =>
                {
                    ...
                    b.HasOne("BeHealthyProject.Entities.User", null)
                        .WithMany("Subscribers")
                        .HasForeignKey("UserId");
                });
